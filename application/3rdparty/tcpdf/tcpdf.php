...
//  * automatic page header and footer management;Footer
...
// Patrick Benny for text stretch suggestion on Cell().Footer
...
class TCPDF {
	...
	public function setHeaderLc($lc=array(0,0,0)) {		
		$this->header_line_color = $lc;
	}
	...
	public function Header() {
		if ($this->header_xobjid < 0) {
			...
			$this->SetLineStyle(array('width' => 2 / $this->k, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => $headerdata['line_color']));
