...
<?php if ($a == 'admin' OR $a == 'valija_coord' OR $a == 'valija_ingreso' OR $a == 'valija_despacho' OR $a == 'mixto' OR $a== 'valija_ing_des'): ?>
...
<div id="valija" class="hidden">
	<ul>
		<?php if ($a == 'admin' OR $a == 'valija_coord' OR $a == 'valija_ingreso' OR $a == 'mixto' OR $a== 'valija_ing_des'): ?>
		<li><a href="#">Ingreso</a>
			<ul>
		...
		<?php endif; ?>
		<?php if ($a == 'admin' OR $a == 'valija_coord' OR $a == 'valija_despacho' OR $a == 'mixto'OR $a== 'valija_ing_des'): ?>
